...
public:
    ...
    SynthesizerTrn();
    static Mat forward(const Mat& x, const Nets* nets, bool vulkan = false, int sid = 0, bool voice_convrt = false, float noise_scale = .667, float noise_scale_w = 0.8, float length_scale = 1);
    ~SynthesizerTrn();
};
