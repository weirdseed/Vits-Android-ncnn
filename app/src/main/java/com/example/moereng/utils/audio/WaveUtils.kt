...
import com.example.moereng.data.WavHead
import java.io.File
...
object WaveUtils {
    ...
    fun writeWav(audioData: FloatArray, folder: String, samplingRate: Int, name: String): String {
        var path = ""
        path = if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
            ...
            val permission =
                ContextCompat.checkSelfPermission(MoeRengApplication.context, readRequest)
